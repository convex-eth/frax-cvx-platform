...
contract StakingProxyConvex is StakingProxyBase, ReentrancyGuard {
        ...
        nonReentrant
    {
        ...
        //unwrap
        IConvexWrapper(stakingToken).withdrawAndUnwrap(
        ...
        )
    {
        ...
        IConvexWrapper.EarnedData[] memory convexrewards = IConvexWrapper(
            stakingToken
        ).earned(address(this));
    ...
    /// Could also be callable by an authorized address rather than only owner.
